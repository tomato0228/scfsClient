class TestEntity {
	...
	TestEntity.fromJson(Map<String, dynamic> json) {
		...
		if (json['data'] != null) {
			...
			(json['data'] as List).forEach((v) { data.add(new TestData.fromJson(v)); });
		}
...
class TestData {
	...
	TestData({this.userSignature, this.userSex, this.chatDate, this.chatId, this.otherId, this.userAddr, this.userTel, this.userBirth, this.chatContent, this.userName, this.chatMesg, this.userId, this.userProfile, this.chatMesgnum, this.userEmail, this.userType, this.chatType});
