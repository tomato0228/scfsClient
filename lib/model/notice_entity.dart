class NoticeEntity {
	...
	NoticeEntity.fromJson(Map<String, dynamic> json) {
		...
		if (json['data'] != null) {
			...
			(json['data'] as List).forEach((v) { data.add(new NoticeData.fromJson(v)); });
		}
...
class NoticeData {
	...
	NoticeData({this.userSignature, this.userSex, this.userAddr, this.className, this.userTel, this.userName, this.userId, this.noticeId, this.noticeTitle, this.userProfile, this.noticeContent, this.classId, this.noticeDate, this.userEmail, this.userType, this.noticeAttachment});
