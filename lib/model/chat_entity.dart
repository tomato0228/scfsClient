class ChatEntity {
	...
	ChatEntity.fromJson(Map<String, dynamic> json) {
		...
		if (json['data'] != null) {
			...
			(json['data'] as List).forEach((v) { data.add(new ChatData.fromJson(v)); });
		}
...
class ChatData {
	...
	ChatData({this.chatDate, this.sendId, this.chatId, this.chatContent, this.chatMesg, this.chatType, this.receiveId});
